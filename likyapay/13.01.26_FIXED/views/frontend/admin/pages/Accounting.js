                        ...
                        <div className="relative">
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    onChange={e => setInvoice({ ...invoice, recipient_name: e.target.value, entity_id: null })} // Clear ID on manual edit
...
window.Admin.Pages.Accounting = ({ users }) => {
    ...
    const systemEntities = React.useMemo(() => {
        ...
        return users.map(u => ({
            ...
            tax_id: u.taxNo || u.tax_id || '', // Fix: dashboard.js maps it to taxNo
            address: u.address || ''
        }));
    }, [users]);
            ...
            {activeTab === 'cash' ? (
                                ...
                                {cashTransactions.map(t => (
                                    <tr key={t.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="p-4 text-right flex justify-end gap-2">
                                            ...
                                            <button onClick={() => window.open(`../data/api/system_accounting.php?action=print_invoice&id=${t.id}`, '_blank')} className="text-gray-300 hover:text-indigo-600 transition" title="İndir">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-fade-in-up">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 bg-gray-50 border-b border-gray-100">
                        ...
                        <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                            <div className="text-xs font-bold text-gray-400 uppercase mb-1">Toplam KDV</div>
                                ...
                                invoiceTransactions.map(inv => (
                                    <tr key={inv.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="p-4 flex gap-2 justify-end">
                                            ...
                                            <button onClick={() => window.open(`../data/api/system_accounting.php?action=print_invoice&id=${inv.id}`, '_blank')} className="text-slate-400 hover:text-indigo-600 transition" title="İndir">
                                                <i className="fas fa-download"></i>
                                            </button>
