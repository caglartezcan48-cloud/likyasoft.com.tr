...
const App = () => {
    ...
    useEffect(() => {
        const checkSession = async () => {
            try {
                ...
                const response = await fetch('/likyasoft/public/likyapay/data/api/check_session.php');
    ...
    const handleLogout = async () => {
        ...
        try {
            await fetch('/likyasoft/public/likyapay/data/api/logout.php');
        } catch (e) {
        ...
        window.location.replace('/likyasoft/public/likyapay/index.php');
    };
