...
// Simple GET check for debugging
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    echo json_encode(['success' => true, 'message' => 'LİKYAPAY API ÇALIŞIYOR']);
    exit;
}
...
";
    ...
    // Return 200 so frontend can read the JSON error message
