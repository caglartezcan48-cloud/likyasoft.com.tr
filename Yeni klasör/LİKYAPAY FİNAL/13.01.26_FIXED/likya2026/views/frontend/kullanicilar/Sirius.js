                ...
                <div className="bg-white rounded-2xl w-full max-w-4xl h-[85vh] flex flex-col shadow-2xl relative overflow-hidden">
                    <div className="bg-slate-50 border-b p-4 flex justify-between items-center z-10">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                onClick={() => window.open(`../data/api/sirius.php?action=download_my_contract&cycle_id=${activeCycle.id}&type=${activeDocTab}`, '_blank')}
                                className="text-indigo-600 hover:text-indigo-800 font-bold text-sm bg-indigo-50 px-3 py-2 rounded-lg transition"
                            >
                                <i className="fas fa-print mr-1"></i> Yazdır / İndir
                            </button>
