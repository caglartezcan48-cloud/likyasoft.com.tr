    ...
    return (
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-slate-900 text-white animate-fade-out-delay">
            <div className="text-center animate-bounce-in">
                {/* Logo or Icon */}
                <div className="w-32 h-32 md:w-48 md:h-48 mb-8 mx-auto bg-white rounded-full flex items-center justify-center shadow-2xl shadow-blue-500/50 border-4 border-blue-400 p-0 overflow-hidden">
                    <img src="frontend/gorsel/logo.png" alt="Logo" className="w-full h-full object-cover drop-shadow-2xl animate-pulse scale-150" />
                </div>
