...
window.Anasayfa.LoginModal = ({ isOpen, onClose, onLogin, onRegisterClick }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            // Network delay removed for performance
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden relative transform transition-all scale-100 hover:scale-[1.01] duration-300 border border-white/20">
                ...
                <div className="bg-gradient-to-br from-brand-900 via-brand-800 to-blue-900 p-8 text-white text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="w-24 h-24 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4 backdrop-blur-sm border border-white/20 shadow-inner overflow-hidden p-0">
                            <img src="frontend/gorsel/logo.png" alt="Logo" className="w-full h-full object-cover scale-110" />
                        </div>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6 bg-white">
                    <div className="space-y-1">
                        ...
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide ml-1">E-Posta / Kullanıcı Adı / Telefon</label>
                        <div className="relative group">
                            <i className="fas fa-user absolute left-4 top-4 text-gray-400 group-focus-within:text-brand-600 transition-colors"></i>
                            <input
                                type="text"
                                ...
                                placeholder="E-posta, İsim veya 5XX..."
                                value={email}
