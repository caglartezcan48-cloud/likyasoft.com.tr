...
<head>
    ...
    <meta name="description"
        content="LikyaPay, KOBİ'ler ve şirketler için nakitsiz borç ödeme ve alacak tahsilat platformudur. Sirius Döngü Algoritması ile borçlarınızı nakit kullanmadan kapatın.">
    <meta name="keywords"
        content="borç mahsuplaşma, kobi finans, nakit akışı, takas sistemi, sirius döngüsü, alacak tahsilatı, ticari borç, bartering">
    ...
    <meta property="og:description"
        content="KOBİ'ler borçlarını birbirine devrederek kapatsın. Nakit sıkışıklığına son verin.">
    ...
    <meta property="og:description"
        content="Likya Pay ile ticari borç ve alacaklarınızı nakit akışına ihtiyaç duymadan mahsuplaşarak yönetin. KOBİ'ler için güvenli finansal çözüm.">
    <meta property="og:image" content="https://likyapaydemo.gt.tc/views/frontend/gorsel/logo.png">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://likyapaydemo.gt.tc/">
    <meta property="twitter:title" content="Likya Pay | Yeni Nesil Finansal Optimizasyon">
    <meta property="twitter:description"
        content="Likya Pay ile ticari borç ve alacaklarınızı nakit akışına ihtiyaç duymadan mahsuplaşarak yönetin.">
    <meta property="twitter:image" content="https://likyapaydemo.gt.tc/views/frontend/gorsel/logo.png">
    ...
    <!-- Local Styles -->
    <link rel="stylesheet" href="/views/frontend/css/style.css?v=20260114_GLASS">
</head>
...
<body>
    ...
    <div id="root">
        ...
        <div
            style="height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; background-color: #f8fafc; font-family: sans-serif;">
            <div
                style="width: 50px; height: 50px; border: 4px solid #e0f2fe; border-top: 4px solid #0284c7; border-radius: 50%; animation: spin 1s linear infinite;">
            </div>
    ...
    <noscript>
        <div style="padding: 20px; line-height: 1.6; color: #333;">
            ...
            <p>Likya Pay, KOBİ'ler ve ticari işletmeler için geliştirilmiş, nakit paraya ihtiyaç duymadan borç ödeme
                sistemidir.</p>
            <h2>Neden Likya Pay?</h2>
            <ul>
                <li><strong>Sirius Döngüsü:</strong> Yapay zeka destekli algoritmamız ile piyasadaki kilitlenmiş borç
                    zincirlerini tespit edin ve nakitsiz ödeyin.</li>
            ...
            <p>Siz de tedarikçinize olan borcunuzu, müşterinizden olan alacağınızla ödeyin. Finansal özgürlüğün yeni
                yolu.</p>
    ...
    <!-- 1. Utils & Logic -->
    <!-- 1. Utils & Logic -->
    <script type="text/babel" src="/views/frontend/utils/Validators.js?v=20260115_VAL"></script>
    ...
    <script type="text/babel" src="/views/frontend/components/NotificationToast.js?v=20260114_NOTIFY"></script>
    <script type="text/babel" src="/views/frontend/components/NotificationToast.js?v=20260114_NOTIFY"></script>

    <!-- ChatBot (Only for Guests and Users, NOT Admin) -->
    <?php if ($role !== 'admin' && $role !== 'accountant'): ?>
        <script type="text/babel" src="/views/frontend/components/ChatBot.js?v=20260114_AI"></script>
    <?php endif; ?>
    ...
    <script type="text/babel" src="/views/frontend/anasayfa/Navbar.js?v=20260121_MOBILE"></script>
    ...
    <script type="text/babel" src="/views/frontend/anasayfa/TrustedBy.js?v=20260115_TRUST"></script>
    <script type="text/babel" src="/views/frontend/anasayfa/Stats.js?v=20260115_STATS"></script>
    <script type="text/babel" src="/views/frontend/anasayfa/HomePage.js?v=20260114_PREMIUM"></script>
    ...
    <?php if ($role === 'admin' || $role === 'accountant'): ?>
        <script type="text/babel" src="/views/frontend/admin/layout/Sidebar.js?v=ACC_FIX_1"></script>
        ...
        <script type="text/babel" src="/views/frontend/admin/pages/SiriusArchive.js?v=20260120_ARCH"></script>
        <script type="text/babel" src="/views/frontend/admin/pages/AdminMessages.js?v=20260114_MSG"></script>
    ...
    <?php if ($role === 'user'): ?>
        ...
        <script type="text/babel" src="/views/frontend/kullanicilar/MyCompanies.js?v=20260115_MYCOMP_PORTAL_V2"></script>
        <script type="text/babel" src="/views/frontend/kullanicilar/Archive.js?v=20260106_ARCHIVE_FINAL_V2"></script>
        <script type="text/babel" src="/views/frontend/kullanicilar/Messages.js?v=20260114_MSG"></script>
    ...
    <!-- 3. Main App -->
    <script type="text/babel" src="/views/frontend/app.js?v=20260114_PRELOAD"></script>
</body>
