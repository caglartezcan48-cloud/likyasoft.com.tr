...
window.Kullanicilar.Sirius = () => {
    ...
    const fetchRequests = async () => {
        setLoading(true);
        try {
            const res = await fetch('/likyasoft/public/likyapay/data/api/sirius.php?action=list_requests');
    ...
    React.useEffect(() => {
        ...
        // Check Cycle Status
        fetch('/likyasoft/public/likyapay/data/api/sirius.php?action=check_my_cycle')
            .then(res => res.json())
            .then(data => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch('/likyasoft/public/likyapay/data/api/sirius.php', {
                method: 'POST',
