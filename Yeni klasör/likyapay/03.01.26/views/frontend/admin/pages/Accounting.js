...
window.Admin.Pages.Accounting = ({ users }) => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const [resCash, resInvoices] = await Promise.all([
                fetch('/likyasoft/public/likyapay/data/api/system_accounting.php?t=' + Date.now()).then(r => r.json()),
                fetch('/likyasoft/public/likyapay/data/api/admin_transactions.php?t=' + Date.now()).then(r => r.json()) // Fetch ALL user transactions
            ]);
    ...
    const handleSaveTransaction = async (transaction) => {
        ...
        try {
            ...
            const response = await fetch('/likyasoft/public/likyapay/data/api/system_accounting.php', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await fetch('/likyasoft/public/likyapay/data/api/system_accounting.php', { method: 'DELETE', body: JSON.stringify({ id }) });
            fetchData();
        } catch (e) { }
    };
