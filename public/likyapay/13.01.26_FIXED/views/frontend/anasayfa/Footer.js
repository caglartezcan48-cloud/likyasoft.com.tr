            ...
            <div className="border-t border-slate-800 col-span-1 md:col-span-4 pt-8 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        ...
                        <li><a href="/likyasoft/public/likyapay/views/frontend/yasal/sozlesme.php" className="text-brand-100/60 hover:text-white transition-colors text-sm">{t.menu_terms}</a></li>
                        <li><a href="/likyasoft/public/likyapay/views/frontend/yasal/gizlilik.php" className="text-brand-100/60 hover:text-white transition-colors text-sm">{t.menu_privacy}</a></li>
                        <li><a href="/likyasoft/public/likyapay/views/frontend/yasal/kvkk.php" className="text-brand-100/60 hover:text-white transition-colors text-sm">{t.menu_kvkk}</a></li>
                    </ul>
                </div>
                <div>
