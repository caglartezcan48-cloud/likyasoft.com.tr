...
window.Admin.Pages.Users = () => {
    ...
    const fetchUsers = async () => {
        setLoading(true);
        const apiUrl = '/likyasoft/public/likyapay/data/api/companies.php?t=' + Date.now();
    ...
    const handleDeleteClick = async (id) => {
        ...
        try {
            const response = await fetch('/likyasoft/public/likyapay/data/api/delete_user.php', {
                method: 'POST',
    ...
    const handleSaveUser = async () => {
        ...
        try {
            let url = '/likyasoft/public/likyapay/data/api/register.php';
            if (isEditing) {
                url = '/likyasoft/public/likyapay/data/api/update_user.php';
