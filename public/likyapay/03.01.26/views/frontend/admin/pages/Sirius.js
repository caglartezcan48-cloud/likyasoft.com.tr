...
window.Admin.Pages.Sirius = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const res = await fetch('/likyasoft/public/likyapay/data/api/sirius.php?action=list_all_cycles');
    ...
    const handleRunEngine = async () => {
        try {
            const res = await fetch('/likyasoft/public/likyapay/data/api/sirius.php?action=run_engine', { method: 'POST' });
            const data = await res.json();
    ...
    const handleApprove = async (id) => {
        ...
        try {
            const res = await fetch('/likyasoft/public/likyapay/data/api/sirius.php?action=approve_cycle', {
                method: 'POST',
