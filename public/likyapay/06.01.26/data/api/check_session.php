...
if (isset($_SESSION['user_id'])) {
    ...
    try {
        ...
        $stmt = $db->prepare("SELECT id, name, email, phone, role, authorized_person, invoice_address, address, tax_id, tax_office, mersis_no, trade_registry_no FROM users WHERE id = :id");
